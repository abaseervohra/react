...
import { Button } from "../Button/Button";
  ...
  return (
    <>
      <div className={styles.campus_section}>
       ...
       <div className={styles.heading_text}>
        ...
        <div className={styles.campus_content}>
          <div className={styles.campus_left_content}>
            <li class={styles.listing_campus} data-wow-duration="0.3s">
              ...
              <div class={styles.text}>
                ...
                <p>
                  Why I say old chap that is spiffing he legged <br></br>it in
                  my flat easy peasy.
                </p>
              </div>
              <a href="/">
          ...
          <div className={styles.campus_right_content}>
            <img src={campus} />
          </div>
        </div>
